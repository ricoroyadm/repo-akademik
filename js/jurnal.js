...
const links = {
  ...
  syam: "https://drive.google.com/drive/folders/1YQ_-E4HGqb_zfUj301beFTeXbEv25vME?usp=drive_link",
...
const btnSyam = document.getElementById("btnSyam");
...
btnSyam.addEventListener("click", () => {
  window.open(links.syam, "_blank");
});
